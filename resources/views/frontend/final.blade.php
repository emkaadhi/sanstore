...
@section('content')
    <div class="container">
        <div class="row my-5">
            <div class="col-md-10">
                <div class="card">
                    <div class="text-left logo p-2 px-5"> <img src="{{ asset('images/site/sanstore.png') }}" width="125">
                    </div>
                    <div class="invoice p-2">
                        <h5>Pesanan anda telah terkonfirmasi</h5> <span class="font-weight-bold d-block mt-4">Halo,
                            {{ $order->user->name }}
                        </span>
                        <span>Pesanan akan dikirim dalam 2 hari setelah anda melakukan pembayaran , silakan cek di riwayat
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="py-2"> <span
                                                ...
                                                <span><img src="{{ asset('images/site/gopay.png') }}" width="40" /></span>
                                                <span><img src="{{ asset('images/site/ovo.png') }}" width="40" /></span>
                                                <span><img src="{{ asset('images/site/bri.png') }}" width="40" /></span>
                            ...
                            <table class="table table-borderless">
                                <tbody>
                                    @foreach ($order->order_detail as $order_detail)
                                        <tr>
                                            <td width="20%"> <img
                                                    src="{{ asset('images/product/' . $order_detail->product->image) }}"
                                                    width="90">
                                            </td>
                                            <td width="30%"> <span
                                            ...
                                            <td>
                                                <div class="product-qty"><span
                                                        class="d-block">{{ $order_detail->quantity }} pcs</span>
                                                </div>
                                            </td>
                                            <td width="20%">
                                                <div class="text-right"> <span
                                                        class="text-lead">Rp.{{ number_format($order_detail->product->price * $order_detail->quantity, 2) }}</span>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
                        ...
                        <p class="font-weight-bold mb-0">Terima kasih telah mempercayai kami sebagai mitra terpercaya anda !
